...
THEORY ListInvariantX IS
  ...
  Abstract_List_Invariant(Implementation(awsEc2SimulatorCtxImpl))==(VM_CATEGORIES: FIN(VM_CATEGORIES) & VIRTUAL_MACHINES: FIN(VIRTUAL_MACHINES));
...
THEORY ListValuesX IS
  ...
  Values_Subs(Implementation(awsEc2SimulatorCtxImpl))==(MACHINE_RESOURCES,VIRTUAL_MACHINES,VM_CATEGORIES,allocated,spot,USERS,none,admin: 0..100,1..1000,{0,1},0,1,1..10000,1,2);
  List_Values(Implementation(awsEc2SimulatorCtxImpl))==(MACHINE_RESOURCES = 0..100;VIRTUAL_MACHINES = 1..1000;VM_CATEGORIES = {0,1};allocated = 0;spot = 1;USERS = 1..10000;none = 1;admin = 2)
END
&
