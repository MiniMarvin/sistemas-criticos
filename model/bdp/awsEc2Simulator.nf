...
THEORY ListVariablesX IS
  ...
  Local_List_Variables(Machine(awsEc2Simulator))==(currentUser,finishedInstanceCost,instanceRating,currentTime,allocatedVirtualMachines,spotVirtualMachines,vmCategories,virtualMachineProperties,virtualMachines,clients,admins,machineResourceProperties,machineResources);
  List_Variables(Machine(awsEc2Simulator))==(currentUser,finishedInstanceCost,instanceRating,currentTime,allocatedVirtualMachines,spotVirtualMachines,vmCategories,virtualMachineProperties,virtualMachines,clients,admins,machineResourceProperties,machineResources);
  External_List_Variables(Machine(awsEc2Simulator))==(currentUser,finishedInstanceCost,instanceRating,currentTime,allocatedVirtualMachines,spotVirtualMachines,vmCategories,virtualMachineProperties,virtualMachines,clients,admins,machineResourceProperties,machineResources)
END
&
...
THEORY ListInvariantX IS
  ...
  Context_List_Invariant(Machine(awsEc2Simulator))==(USERS: FIN(USERS) & VM_CATEGORIES: FIN(VM_CATEGORIES) & VIRTUAL_MACHINES: FIN(VIRTUAL_MACHINES) & MACHINE_RESOURCES: FIN(MACHINE_RESOURCES));
  List_Invariant(Machine(awsEc2Simulator))==(currentUser: USERS & admins <: USERS & clients <: USERS & admins/\clients = {} & admins/={} & currentTime: 0..100 & MACHINE_RESOURCES: FIN(MACHINE_RESOURCES) & machineResources <: MACHINE_RESOURCES & machineResourceProperties: machineResources +-> struct(cpu>>NAT1,hdd>>NAT1,mem>>NAT1) & VIRTUAL_MACHINES: FIN(VIRTUAL_MACHINES) & VM_CATEGORIES: FIN(VM_CATEGORIES) & vmCategories <: VM_CATEGORIES & virtualMachines <: VIRTUAL_MACHINES & virtualMachines: FIN(virtualMachines) & virtualMachineProperties: virtualMachines --> struct(residentMachine>>MACHINE_RESOURCES,owner>>USERS,category>>VM_CATEGORIES,startTime>>NAT,cpu>>NAT1,hdd>>NAT1,mem>>NAT1) & virtualMachineProperties: FIN(virtualMachineProperties) & spotVirtualMachines <: virtualMachines & allocatedVirtualMachines <: virtualMachines & spotVirtualMachines\/allocatedVirtualMachines = virtualMachines & spotVirtualMachines/\allocatedVirtualMachines = {} & finishedInstanceCost: USERS +-> NAT & instanceRating: {allocated,spot} +-> struct(cpu>>NAT,hdd>>NAT,mem>>NAT))
END
&
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Machine(awsEc2Simulator))==(admins,currentUser,clients,machineResources,machineResourceProperties,virtualMachines,virtualMachineProperties,vmCategories,spotVirtualMachines,allocatedVirtualMachines,currentTime,instanceRating,finishedInstanceCost:={admin},none,{},{},{},{},{},{allocated,spot},{},{},0,{allocated|->rec(cpu>>2,hdd>>2,mem>>2),spot|->rec(cpu>>1,hdd>>1,mem>>1)},{});
  Context_List_Initialisation(Machine(awsEc2Simulator))==(skip);
  List_Initialisation(Machine(awsEc2Simulator))==(admins:={admin} || currentUser:=none || clients:={} || machineResources:={} || machineResourceProperties:={} || virtualMachines:={} || virtualMachineProperties:={} || vmCategories:={allocated,spot} || spotVirtualMachines:={} || allocatedVirtualMachines:={} || currentTime:=0 || instanceRating:={allocated|->rec(cpu>>2,hdd>>2,mem>>2),spot|->rec(cpu>>1,hdd>>1,mem>>1)} || finishedInstanceCost:={})
END
&
...
THEORY ListOperationsX IS
  Internal_List_Operations(Machine(awsEc2Simulator))==(setInstanceRating,login,logout,addClient,addArbitraryClient,addAdmin,removeAdmin,removeClient,listClients,tickTimer,addResource,removeResource,listResources,addAllocatedVirtualMachine,addSpotVirtualMachine,removeVirtualMachine,getAllocatedVmsOnMachine,getAllocatedCpuOnMachine,listVmsForUser,getBillingForRunningVM,getBillingForUser);
  List_Operations(Machine(awsEc2Simulator))==(setInstanceRating,login,logout,addClient,addArbitraryClient,addAdmin,removeAdmin,removeClient,listClients,tickTimer,addResource,removeResource,listResources,addAllocatedVirtualMachine,addSpotVirtualMachine,removeVirtualMachine,getAllocatedVmsOnMachine,getAllocatedCpuOnMachine,listVmsForUser,getBillingForRunningVM,getBillingForUser)
END
&
THEORY ListInputX IS
  List_Input(Machine(awsEc2Simulator),setInstanceRating)==(instanceType,cpuRating,hddRating,memRating);
  List_Input(Machine(awsEc2Simulator),login)==(user);
  List_Input(Machine(awsEc2Simulator),logout)==(?);
  List_Input(Machine(awsEc2Simulator),addClient)==(user);
  List_Input(Machine(awsEc2Simulator),addArbitraryClient)==(?);
  List_Input(Machine(awsEc2Simulator),addAdmin)==(user);
  List_Input(Machine(awsEc2Simulator),removeAdmin)==(user);
  List_Input(Machine(awsEc2Simulator),removeClient)==(user);
  List_Input(Machine(awsEc2Simulator),listClients)==(user);
  List_Input(Machine(awsEc2Simulator),tickTimer)==(?);
  List_Input(Machine(awsEc2Simulator),addResource)==(cpu,hdd,mem);
  List_Input(Machine(awsEc2Simulator),removeResource)==(resource);
  ...
  List_Input(Machine(awsEc2Simulator),removeVirtualMachine)==(vm);
  ...
  List_Input(Machine(awsEc2Simulator),listVmsForUser)==(resourceTypes,user);
  List_Input(Machine(awsEc2Simulator),getBillingForRunningVM)==(vm);
  List_Input(Machine(awsEc2Simulator),getBillingForUser)==(user)
END
&
THEORY ListOutputX IS
  List_Output(Machine(awsEc2Simulator),setInstanceRating)==(?);
  List_Output(Machine(awsEc2Simulator),login)==(?);
  List_Output(Machine(awsEc2Simulator),logout)==(?);
  List_Output(Machine(awsEc2Simulator),addClient)==(?);
  List_Output(Machine(awsEc2Simulator),addArbitraryClient)==(?);
...
THEORY ListHeaderX IS
  List_Header(Machine(awsEc2Simulator),setInstanceRating)==(setInstanceRating(instanceType,cpuRating,hddRating,memRating));
  List_Header(Machine(awsEc2Simulator),login)==(login(user));
  List_Header(Machine(awsEc2Simulator),logout)==(logout);
  List_Header(Machine(awsEc2Simulator),addClient)==(addClient(user));
  List_Header(Machine(awsEc2Simulator),addArbitraryClient)==(addArbitraryClient);
  List_Header(Machine(awsEc2Simulator),addAdmin)==(addAdmin(user));
  List_Header(Machine(awsEc2Simulator),removeAdmin)==(removeAdmin(user));
  List_Header(Machine(awsEc2Simulator),removeClient)==(removeClient(user));
  List_Header(Machine(awsEc2Simulator),listClients)==(clientList <-- listClients(user));
  List_Header(Machine(awsEc2Simulator),tickTimer)==(tickTimer);
  List_Header(Machine(awsEc2Simulator),addResource)==(addResource(cpu,hdd,mem));
  List_Header(Machine(awsEc2Simulator),removeResource)==(removeResource(resource));
  ...
  List_Header(Machine(awsEc2Simulator),removeVirtualMachine)==(removeVirtualMachine(vm));
  ...
  List_Header(Machine(awsEc2Simulator),listVmsForUser)==(vmList <-- listVmsForUser(resourceTypes,user));
  List_Header(Machine(awsEc2Simulator),getBillingForRunningVM)==(billing <-- getBillingForRunningVM(vm));
  List_Header(Machine(awsEc2Simulator),getBillingForUser)==(billing <-- getBillingForUser(user))
END
&
THEORY ListOperationGuardX END
&
THEORY ListPreconditionX IS
  List_Precondition(Machine(awsEc2Simulator),setInstanceRating)==(instanceType: {allocated,spot} & cpuRating: NAT1 & hddRating: NAT1 & memRating: NAT1 & hddRating: NAT1 & currentUser: {admin});
  List_Precondition(Machine(awsEc2Simulator),login)==(currentUser = none & user: admins\/clients);
  List_Precondition(Machine(awsEc2Simulator),logout)==(currentUser/=none);
  List_Precondition(Machine(awsEc2Simulator),addClient)==(user: USERS & user/:clients & user/:admins & currentUser: admins & user/=none);
  List_Precondition(Machine(awsEc2Simulator),addArbitraryClient)==(currentUser: admins);
  List_Precondition(Machine(awsEc2Simulator),addAdmin)==(user: USERS & user/:clients & user/:admins & currentUser: admins & user/=none);
  List_Precondition(Machine(awsEc2Simulator),removeAdmin)==(user: USERS & user: admins & admins-{user}/={} & currentUser: admins);
  List_Precondition(Machine(awsEc2Simulator),removeClient)==(user: USERS & user: clients & currentUser: admins & {vmp | vmp: ran(virtualMachineProperties) & vmp'owner = user} = {});
  List_Precondition(Machine(awsEc2Simulator),listClients)==(user: USERS & currentUser: admins);
  List_Precondition(Machine(awsEc2Simulator),tickTimer)==(btrue);
  List_Precondition(Machine(awsEc2Simulator),addResource)==(cpu: NAT1 & hdd: NAT1 & mem: NAT1 & currentUser: admins);
  List_Precondition(Machine(awsEc2Simulator),removeResource)==(resource: machineResources & resource: machineResources & currentUser: admins & {vm | vm: virtualMachines & virtualMachineProperties(vm)'residentMachine = resource} = {});
  ...
  List_Precondition(Machine(awsEc2Simulator),listVmsForUser)==(resourceTypes <: VM_CATEGORIES & user: USERS & currentUser: admins\/{user});
  List_Precondition(Machine(awsEc2Simulator),getBillingForRunningVM)==(vm: virtualMachines & currentUser: admins\/{virtualMachineProperties(vm)'owner} & virtualMachineProperties(vm)'category: dom(instanceRating));
  List_Precondition(Machine(awsEc2Simulator),getBillingForUser)==(user: clients & user: dom(finishedInstanceCost) & currentUser: admins\/{user})
END
&
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Machine(awsEc2Simulator),getBillingForUser)==(user: clients & user: dom(finishedInstanceCost) & currentUser: admins\/{user} | billing:=SIGMA(vm).(vm: dom(virtualMachineProperties) & virtualMachineProperties(vm)'owner = user & virtualMachineProperties(vm)'category: dom(instanceRating) | virtualMachineProperties(vm)'cpu*instanceRating(virtualMachineProperties(vm)'category)'cpu*(currentTime-virtualMachineProperties(vm)'startTime)+virtualMachineProperties(vm)'hdd*instanceRating(virtualMachineProperties(vm)'category)'hdd*(currentTime-virtualMachineProperties(vm)'startTime)+virtualMachineProperties(vm)'mem*instanceRating(virtualMachineProperties(vm)'category)'mem*(currentTime-virtualMachineProperties(vm)'startTime))+finishedInstanceCost(user));
  Expanded_List_Substitution(Machine(awsEc2Simulator),getBillingForRunningVM)==(vm: virtualMachines & currentUser: admins\/{virtualMachineProperties(vm)'owner} & virtualMachineProperties(vm)'category: dom(instanceRating) | billing:=instanceRating(virtualMachineProperties(vm)'category)'cpu*virtualMachineProperties(vm)'cpu*(currentTime-virtualMachineProperties(vm)'startTime)+instanceRating(virtualMachineProperties(vm)'category)'hdd*virtualMachineProperties(vm)'hdd*(currentTime-virtualMachineProperties(vm)'startTime)+instanceRating(virtualMachineProperties(vm)'category)'mem*virtualMachineProperties(vm)'mem*(currentTime-virtualMachineProperties(vm)'startTime));
  Expanded_List_Substitution(Machine(awsEc2Simulator),listVmsForUser)==(resourceTypes <: VM_CATEGORIES & user: USERS & currentUser: admins\/{user} | vmList:={vm | vm: dom(virtualMachineProperties) & virtualMachineProperties(vm)'owner = user});
  ...
  Expanded_List_Substitution(Machine(awsEc2Simulator),addAllocatedVirtualMachine)==(cpu: NAT1 & hdd: NAT1 & mem: NAT1 & client: clients | @(machine,vm).(vm: VIRTUAL_MACHINES & vm/:virtualMachines & vm/:spotVirtualMachines & vm/:allocatedVirtualMachines & machine: machineResources & machine: dom(machineResourceProperties) & cpu<=machineResourceProperties(machine)'cpu-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'cpu) & hdd<=machineResourceProperties(machine)'hdd-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'hdd) & mem<=machineResourceProperties(machine)'mem-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'mem) ==> @pset.(pset <: virtualMachineProperties & cpu<=machineResourceProperties(machine)'cpu-SIGMA(vm1).(vm1: dom(virtualMachineProperties) & virtualMachineProperties(vm1)'residentMachine = machine & virtualMachineProperties(vm1)'category = allocated | virtualMachineProperties(vm1)'cpu)+SIGMA(vm2).(vm2: dom(pset) & pset(vm2)'residentMachine = machine & pset(vm2)'category = spot | pset(vm2)'cpu) & mem<=machineResourceProperties(machine)'mem-SIGMA(vm1).(vm1: dom(virtualMachineProperties) & virtualMachineProperties(vm1)'residentMachine = machine & virtualMachineProperties(vm1)'category = allocated | virtualMachineProperties(vm1)'mem)+SIGMA(vm2).(vm2: dom(pset) & pset(vm2)'residentMachine = machine & pset(vm2)'category = spot | pset(vm2)'mem) & hdd<=machineResourceProperties(machine)'hdd-SIGMA(vm1).(vm1: dom(virtualMachineProperties) & virtualMachineProperties(vm1)'residentMachine = machine & virtualMachineProperties(vm1)'category = allocated | virtualMachineProperties(vm1)'hdd)+SIGMA(vm2).(vm2: dom(pset) & pset(vm2)'residentMachine = machine & pset(vm2)'category = spot | pset(vm2)'hdd) ==> virtualMachines,allocatedVirtualMachines,virtualMachineProperties,spotVirtualMachines:=(virtualMachines\/{vm})-{vm$1 | vm$1: dom(pset) & pset(vm$1)'category = spot & pset(vm$1)'residentMachine = machine},allocatedVirtualMachines\/{vm},{vm$1 | vm$1: dom(pset) & pset(vm$1)'category = spot & pset(vm$1)'residentMachine = machine}<<|(virtualMachineProperties\/{vm|->rec(residentMachine>>machine,owner>>client,category>>allocated,startTime>>currentTime,cpu>>cpu,hdd>>hdd,mem>>mem)}),spotVirtualMachines-{vm$1 | vm$1: dom(pset) & pset(vm$1)'category = spot & pset(vm$1)'residentMachine = machine})));
  Expanded_List_Substitution(Machine(awsEc2Simulator),listResources)==(btrue | resourceList:=machineResourceProperties);
  Expanded_List_Substitution(Machine(awsEc2Simulator),removeResource)==(resource: machineResources & resource: machineResources & currentUser: admins & {vm | vm: virtualMachines & virtualMachineProperties(vm)'residentMachine = resource} = {} | machineResources,machineResourceProperties:=machineResources-{resource},{resource}<<|machineResourceProperties);
  Expanded_List_Substitution(Machine(awsEc2Simulator),addResource)==(cpu: NAT1 & hdd: NAT1 & mem: NAT1 & currentUser: admins | @resource.(resource: MACHINE_RESOURCES & resource/:machineResources & resource/:dom(machineResourceProperties) ==> machineResources,machineResourceProperties:=machineResources\/{resource},machineResourceProperties<+{resource|->rec(cpu>>cpu,hdd>>hdd,mem>>mem)}));
  Expanded_List_Substitution(Machine(awsEc2Simulator),tickTimer)==(btrue | currentTime:=(currentTime+1) mod 100);
  Expanded_List_Substitution(Machine(awsEc2Simulator),listClients)==(user: USERS & currentUser: admins | clientList:=clients);
  Expanded_List_Substitution(Machine(awsEc2Simulator),removeClient)==(user: USERS & user: clients & currentUser: admins & {vmp | vmp: ran(virtualMachineProperties) & vmp'owner = user} = {} | clients,finishedInstanceCost:=clients-{user},{user}<<|finishedInstanceCost);
  Expanded_List_Substitution(Machine(awsEc2Simulator),removeAdmin)==(user: USERS & user: admins & admins-{user}/={} & currentUser: admins | admins:=admins-{user});
  Expanded_List_Substitution(Machine(awsEc2Simulator),addAdmin)==(user: USERS & user/:clients & user/:admins & currentUser: admins & user/=none | admins:=admins\/{user});
  Expanded_List_Substitution(Machine(awsEc2Simulator),addArbitraryClient)==(currentUser: admins | @client.(client: USERS & client/:clients & client/:admins & client/=none ==> clients,finishedInstanceCost:=clients\/{client},finishedInstanceCost<+{client|->0}));
  Expanded_List_Substitution(Machine(awsEc2Simulator),addClient)==(user: USERS & user/:clients & user/:admins & currentUser: admins & user/=none | clients,finishedInstanceCost:=clients\/{user},finishedInstanceCost<+{user|->0});
  Expanded_List_Substitution(Machine(awsEc2Simulator),logout)==(currentUser/=none | currentUser:=none);
  Expanded_List_Substitution(Machine(awsEc2Simulator),login)==(currentUser = none & user: admins\/clients | currentUser:=user);
  Expanded_List_Substitution(Machine(awsEc2Simulator),setInstanceRating)==(instanceType: {allocated,spot} & cpuRating: NAT1 & hddRating: NAT1 & memRating: NAT1 & hddRating: NAT1 & currentUser: {admin} | instanceRating:=instanceRating<+{instanceType|->rec(cpu>>cpuRating,hdd>>hddRating,mem>>memRating)});
  ...
  List_Substitution(Machine(awsEc2Simulator),login)==(currentUser:=user);
  List_Substitution(Machine(awsEc2Simulator),logout)==(currentUser:=none);
  List_Substitution(Machine(awsEc2Simulator),addClient)==(clients:=clients\/{user} || finishedInstanceCost(user):=0);
  List_Substitution(Machine(awsEc2Simulator),addArbitraryClient)==(ANY client WHERE client: USERS & client/:clients & client/:admins & client/=none THEN clients:=clients\/{client} || finishedInstanceCost(client):=0 END);
  ...
  List_Substitution(Machine(awsEc2Simulator),tickTimer)==(currentTime:=(currentTime+1) mod 100);
  ...
  List_Substitution(Machine(awsEc2Simulator),addAllocatedVirtualMachine)==(ANY machine,vm WHERE vm: VIRTUAL_MACHINES & vm/:virtualMachines & vm/:spotVirtualMachines & vm/:allocatedVirtualMachines & machine: machineResources & machine: dom(machineResourceProperties) & cpu<=machineResourceProperties(machine)'cpu-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'cpu) & hdd<=machineResourceProperties(machine)'hdd-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'hdd) & mem<=machineResourceProperties(machine)'mem-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'mem) THEN ANY pset WHERE pset <: virtualMachineProperties & cpu<=machineResourceProperties(machine)'cpu-SIGMA(vm1).(vm1: dom(virtualMachineProperties) & virtualMachineProperties(vm1)'residentMachine = machine & virtualMachineProperties(vm1)'category = allocated | virtualMachineProperties(vm1)'cpu)+SIGMA(vm2).(vm2: dom(pset) & pset(vm2)'residentMachine = machine & pset(vm2)'category = spot | pset(vm2)'cpu) & mem<=machineResourceProperties(machine)'mem-SIGMA(vm1).(vm1: dom(virtualMachineProperties) & virtualMachineProperties(vm1)'residentMachine = machine & virtualMachineProperties(vm1)'category = allocated | virtualMachineProperties(vm1)'mem)+SIGMA(vm2).(vm2: dom(pset) & pset(vm2)'residentMachine = machine & pset(vm2)'category = spot | pset(vm2)'mem) & hdd<=machineResourceProperties(machine)'hdd-SIGMA(vm1).(vm1: dom(virtualMachineProperties) & virtualMachineProperties(vm1)'residentMachine = machine & virtualMachineProperties(vm1)'category = allocated | virtualMachineProperties(vm1)'hdd)+SIGMA(vm2).(vm2: dom(pset) & pset(vm2)'residentMachine = machine & pset(vm2)'category = spot | pset(vm2)'hdd) THEN virtualMachines:=(virtualMachines\/{vm})-{vm | vm: dom(pset) & pset(vm)'category = spot & pset(vm)'residentMachine = machine} || allocatedVirtualMachines:=allocatedVirtualMachines\/{vm} || virtualMachineProperties:={vm | vm: dom(pset) & pset(vm)'category = spot & pset(vm)'residentMachine = machine}<<|(virtualMachineProperties\/{vm|->rec(residentMachine>>machine,owner>>client,category>>allocated,startTime>>currentTime,cpu>>cpu,hdd>>hdd,mem>>mem)}) || spotVirtualMachines:=spotVirtualMachines-{vm | vm: dom(pset) & pset(vm)'category = spot & pset(vm)'residentMachine = machine} END END);
...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(awsEc2Simulator))==(?);
  Inherited_List_Constants(Machine(awsEc2Simulator))==(?);
  List_Constants(Machine(awsEc2Simulator))==(?)
END
&
THEORY ListSetsX IS
...
THEORY ListANYVarX IS
  ...
  List_ANY_Var(Machine(awsEc2Simulator),login)==(?);
  List_ANY_Var(Machine(awsEc2Simulator),logout)==(?);
  List_ANY_Var(Machine(awsEc2Simulator),addClient)==(?);
  List_ANY_Var(Machine(awsEc2Simulator),addArbitraryClient)==(Var(client) == atype(USERS,?,?));
  ...
  List_ANY_Var(Machine(awsEc2Simulator),addAllocatedVirtualMachine)==((Var(machine) == atype(MACHINE_RESOURCES,?,?)),(Var(vm) == atype(VIRTUAL_MACHINES,?,?)),(Var(pset) == SetOf(atype(VIRTUAL_MACHINES,?,?)*rtype(((((((residentMachine: atype(MACHINE_RESOURCES,?,?)),owner: atype(USERS,?,?)),category: atype(VM_CATEGORIES,?,?)),startTime: btype(INTEGER,?,?)),cpu: btype(INTEGER,?,?)),hdd: btype(INTEGER,?,?)),mem: btype(INTEGER,?,?)))));
...
THEORY ListOfIdsX IS
  List_Of_Ids(Machine(awsEc2Simulator)) == (? | ? | currentUser,finishedInstanceCost,instanceRating,currentTime,allocatedVirtualMachines,spotVirtualMachines,vmCategories,virtualMachineProperties,virtualMachines,clients,admins,machineResourceProperties,machineResources | ? | setInstanceRating,login,logout,addClient,addArbitraryClient,addAdmin,removeAdmin,removeClient,listClients,tickTimer,addResource,removeResource,listResources,addAllocatedVirtualMachine,addSpotVirtualMachine,removeVirtualMachine,getAllocatedVmsOnMachine,getAllocatedCpuOnMachine,listVmsForUser,getBillingForRunningVM,getBillingForUser | ? | seen(Machine(awsEc2SimulatorCtx)) | ? | awsEc2Simulator);
  List_Of_HiddenCst_Ids(Machine(awsEc2Simulator)) == (? | ?);
  List_Of_VisibleCst_Ids(Machine(awsEc2Simulator)) == (?);
