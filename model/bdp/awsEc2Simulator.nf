...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(awsEc2Simulator),addAllocatedVirtualMachine)==(cpu: NAT1 & hdd: NAT1 & mem: NAT1 & client: clients | @(machine,vm).(vm: VIRTUAL_MACHINES & vm/:virtualMachines & vm/:spotVirtualMachines & vm/:allocatedVirtualMachines & machine: machineResources & machine: dom(machineResourceProperties) & cpu<=machineResourceProperties(machine)'cpu-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'cpu) & hdd<=machineResourceProperties(machine)'hdd-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'hdd) & mem<=machineResourceProperties(machine)'mem-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'mem) ==> @pset.(pset <: virtualMachineProperties & cpu<=SIGMA(vm1).(vm1: dom(pset) & pset(vm1)'residentMachine = machine & pset(vm1)'category = spot | pset(vm1)'cpu) & mem<=SIGMA(vm1).(vm1: dom(pset) & pset(vm1)'residentMachine = machine & pset(vm1)'category = spot | pset(vm1)'mem) & hdd<=SIGMA(vm1).(vm1: dom(pset) & pset(vm1)'residentMachine = machine & pset(vm1)'category = spot | pset(vm1)'hdd) ==> virtualMachines,allocatedVirtualMachines,virtualMachineProperties,spotVirtualMachines:=(virtualMachines\/{vm})-{vm$1 | vm$1: dom(pset) & pset(vm$1)'category = spot & pset(vm$1)'residentMachine = machine},allocatedVirtualMachines\/{vm},{vm$1 | vm$1: dom(pset) & pset(vm$1)'category = spot & pset(vm$1)'residentMachine = machine}<<|(virtualMachineProperties\/{vm|->rec(residentMachine>>machine,owner>>client,category>>allocated,startTime>>currentTime,cpu>>cpu,hdd>>hdd,mem>>mem)}),spotVirtualMachines-{vm$1 | vm$1: dom(pset) & pset(vm$1)'category = spot & pset(vm$1)'residentMachine = machine})));
  ...
  List_Substitution(Machine(awsEc2Simulator),addAllocatedVirtualMachine)==(ANY machine,vm WHERE vm: VIRTUAL_MACHINES & vm/:virtualMachines & vm/:spotVirtualMachines & vm/:allocatedVirtualMachines & machine: machineResources & machine: dom(machineResourceProperties) & cpu<=machineResourceProperties(machine)'cpu-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'cpu) & hdd<=machineResourceProperties(machine)'hdd-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'hdd) & mem<=machineResourceProperties(machine)'mem-SIGMA(virtualMachine).(virtualMachine: virtualMachines & virtualMachineProperties(virtualMachine)'residentMachine = machine & virtualMachineProperties(virtualMachine)'category = allocated | virtualMachineProperties(virtualMachine)'mem) THEN ANY pset WHERE pset <: virtualMachineProperties & cpu<=SIGMA(vm1).(vm1: dom(pset) & pset(vm1)'residentMachine = machine & pset(vm1)'category = spot | pset(vm1)'cpu) & mem<=SIGMA(vm1).(vm1: dom(pset) & pset(vm1)'residentMachine = machine & pset(vm1)'category = spot | pset(vm1)'mem) & hdd<=SIGMA(vm1).(vm1: dom(pset) & pset(vm1)'residentMachine = machine & pset(vm1)'category = spot | pset(vm1)'hdd) THEN virtualMachines:=(virtualMachines\/{vm})-{vm | vm: dom(pset) & pset(vm)'category = spot & pset(vm)'residentMachine = machine} || allocatedVirtualMachines:=allocatedVirtualMachines\/{vm} || virtualMachineProperties:={vm | vm: dom(pset) & pset(vm)'category = spot & pset(vm)'residentMachine = machine}<<|(virtualMachineProperties\/{vm|->rec(residentMachine>>machine,owner>>client,category>>allocated,startTime>>currentTime,cpu>>cpu,hdd>>hdd,mem>>mem)}) || spotVirtualMachines:=spotVirtualMachines-{vm | vm: dom(pset) & pset(vm)'category = spot & pset(vm)'residentMachine = machine} END END);
