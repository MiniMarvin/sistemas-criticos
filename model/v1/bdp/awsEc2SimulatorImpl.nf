...
THEORY ListInvariantX IS
  ...
  List_Invariant(Implementation(awsEc2SimulatorImpl))==(currentTime: NAT & userSeq: iseq(USERS) & mrSeq: iseq(MACHINE_RESOURCES) & vmSeq: iseq(VIRTUAL_MACHINES) & admins: FIN(admins))
END
&
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Implementation(awsEc2SimulatorImpl))==(admins:={admin};currentUser:=none;clients:={};machineResources:={};machineResourceProperties:={};virtualMachines:={};virtualMachineProperties:={};vmCategories:={allocated,spot};spotVirtualMachines:={};allocatedVirtualMachines:={};(0: INT | currentTime:=0);instanceRating:={allocated|->rec(cpu>>2,hdd>>2,mem>>2),spot|->rec(cpu>>1,hdd>>1,mem>>1)};finishedInstanceCost:={};(ss-1: INT & ss: INT & 1: INT & (ss-1)*card(USERS-{admin,none}): INT & card(USERS-{admin,none}): INT & (ss-1)*card(USERS-{admin,none})+ss: INT & (ss-1)*card(USERS-{admin,none})+ss: dom((1..card(USERS-{admin,none}))*(USERS-{admin,none})) | userSeq:=%ss.(ss: 1..card(USERS-{admin,none}) | ((1..card(USERS-{admin,none}))*(USERS-{admin,none}))((ss-1)*card(USERS-{admin,none})+ss)));(ss-1: INT & ss: INT & 1: INT & (ss-1)*card(MACHINE_RESOURCES): INT & card(MACHINE_RESOURCES): INT & (ss-1)*card(MACHINE_RESOURCES)+ss: INT & (ss-1)*card(MACHINE_RESOURCES)+ss: dom((1..card(MACHINE_RESOURCES))*MACHINE_RESOURCES) | mrSeq:=%ss.(ss: 1..card(MACHINE_RESOURCES) | ((1..card(MACHINE_RESOURCES))*MACHINE_RESOURCES)((ss-1)*card(MACHINE_RESOURCES)+ss)));(ss-1: INT & ss: INT & 1: INT & (ss-1)*card(VIRTUAL_MACHINES): INT & card(VIRTUAL_MACHINES): INT & (ss-1)*card(VIRTUAL_MACHINES)+ss: INT & (ss-1)*card(VIRTUAL_MACHINES)+ss: dom((1..card(VIRTUAL_MACHINES))*VIRTUAL_MACHINES) | vmSeq:=%ss.(ss: 1..card(VIRTUAL_MACHINES) | ((1..card(VIRTUAL_MACHINES))*VIRTUAL_MACHINES)((ss-1)*card(VIRTUAL_MACHINES)+ss))));
  Context_List_Initialisation(Implementation(awsEc2SimulatorImpl))==(skip);
  List_Initialisation(Implementation(awsEc2SimulatorImpl))==(admins:={admin};currentUser:=none;clients:={};machineResources:={};machineResourceProperties:={};virtualMachines:={};virtualMachineProperties:={};vmCategories:={allocated,spot};spotVirtualMachines:={};allocatedVirtualMachines:={};currentTime:=0;instanceRating:={allocated|->rec(cpu>>2,hdd>>2,mem>>2),spot|->rec(cpu>>1,hdd>>1,mem>>1)};finishedInstanceCost:={};userSeq:=%ss.(ss: 1..card(USERS-{admin,none}) | ((1..card(USERS-{admin,none}))*(USERS-{admin,none}))((ss-1)*card(USERS-{admin,none})+ss));mrSeq:=%ss.(ss: 1..card(MACHINE_RESOURCES) | ((1..card(MACHINE_RESOURCES))*MACHINE_RESOURCES)((ss-1)*card(MACHINE_RESOURCES)+ss));vmSeq:=%ss.(ss: 1..card(VIRTUAL_MACHINES) | ((1..card(VIRTUAL_MACHINES))*VIRTUAL_MACHINES)((ss-1)*card(VIRTUAL_MACHINES)+ss)))
END
&
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Implementation(awsEc2SimulatorImpl),tickTimer)==(btrue | currentTime<10000 ==> (currentTime+1: INT & currentTime: INT & 1: INT | currentTime:=currentTime+1) [] not(currentTime<10000) ==> skip);
  ...
  List_Substitution(Implementation(awsEc2SimulatorImpl),tickTimer)==(IF currentTime<10000 THEN currentTime:=currentTime+1 END);
