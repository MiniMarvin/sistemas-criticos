...
THEORY ListOperationsX IS
  Internal_List_Operations(Machine(awsEc2Simulator))==(setInstanceRating,login,logout,addClient,addAdmin,removeAdmin,removeClient,listClients,tickTimer,addResource,removeResource,listResources,addAllocatedVirtualMachine,addSpotVirtualMachine,removeVirtualMachine,getAllocatedVmsOnMachine,getAllocatedCpuOnMachine,listVmsForUser,getBillingForRunningVM,getBillingForUser);
...
THEORY ListPreconditionX IS
  ...
  List_Precondition(Machine(awsEc2Simulator),addClient)==(user: USERS & user/:clients & user/:admins & currentUser: admins);
  List_Precondition(Machine(awsEc2Simulator),addAdmin)==(user: USERS & user/:clients & user/:admins & currentUser: admins);
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(awsEc2Simulator),addAdmin)==(user: USERS & user/:clients & user/:admins & currentUser: admins | admins:=admins\/{user});
  Expanded_List_Substitution(Machine(awsEc2Simulator),addClient)==(user: USERS & user/:clients & user/:admins & currentUser: admins | clients,finishedInstanceCost:=clients\/{user},finishedInstanceCost<+{user|->0});
...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(awsEc2Simulator))==(admin,none);
  Inherited_List_Constants(Machine(awsEc2Simulator))==(?);
  List_Constants(Machine(awsEc2Simulator))==(admin,none)
END
&
THEORY ListSetsX IS
...
THEORY ListPropertiesX IS
  ...
  List_Properties(Machine(awsEc2Simulator))==(admin: USERS & none: USERS)
END
&
...
THEORY ListOfIdsX IS
  List_Of_Ids(Machine(awsEc2Simulator)) == (admin,none | ? | currentUser,finishedInstanceCost,instanceRating,currentTime,allocatedVirtualMachines,spotVirtualMachines,vmCategories,virtualMachineProperties,virtualMachines,clients,admins,machineResourceProperties,machineResources | ? | setInstanceRating,login,logout,addClient,addAdmin,removeAdmin,removeClient,listClients,tickTimer,addResource,removeResource,listResources,addAllocatedVirtualMachine,addSpotVirtualMachine,removeVirtualMachine,getAllocatedVmsOnMachine,getAllocatedCpuOnMachine,listVmsForUser,getBillingForRunningVM,getBillingForUser | ? | seen(Machine(awsEc2SimulatorCtx)) | ? | awsEc2Simulator);
  List_Of_HiddenCst_Ids(Machine(awsEc2Simulator)) == (? | ?);
  List_Of_VisibleCst_Ids(Machine(awsEc2Simulator)) == (admin,none);
...
THEORY ConstantsEnvX IS
  Constants(Machine(awsEc2Simulator)) == (Type(admin) == Cst(atype(USERS,?,?));Type(none) == Cst(atype(USERS,?,?)))
END
&
